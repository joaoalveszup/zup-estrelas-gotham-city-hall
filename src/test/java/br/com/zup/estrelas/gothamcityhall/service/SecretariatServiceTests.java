...
public class SecretariatServiceTests {
	...
	public void shouldCreateSecretariat() {
		...
		Mockito.when(secretariatRepository.findByDepartment(secretariatDTO.getDepartment())).thenReturn(Optional.empty());
	...
	public void shouldNotCreateSecretariatWhenAlreadyExists() {
		...
		Mockito.when(secretariatRepository.findByDepartment(secretariatDTO.getDepartment())).thenReturn(Optional.of(secretariat));
