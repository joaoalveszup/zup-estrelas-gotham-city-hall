...
public class EmployeeService implements IEmployeeService {
    ...
    private void adjustsPayrollBudgetWhenEmployeeUpdated(Employee updatedEmployee, EmployeeDTO employeeDTO) {
        ...
        // FIXME: Gabs, mesmo se a secretaria não for alterada, uma alteração no salário 
        // de um funcionário deve refletir no seu budget. Como está implementado hoje eu consigo
        // dar um aumento para o funcionário sem afetar o budget se não mudá-lo de secretaria.
        if (isSecretariatChanged) {
            ...
            oldAnalizedSecretariat
                    .setPayrollBudget(oldAnalizedSecretariat.getPayrollBudget() + updatedEmployee.getSalary());
            newAnalizedSecretariat
                    .setPayrollBudget(newAnalizedSecretariat.getPayrollBudget() - employeeDTO.getSalary());
